...
PROC PRINTTO LOG = "C:\Users\karmo\OneDrive\Desktop\SAS\dev\faers\log\outc06Q1.log" NEW;
RUN;

PROC IMPORT OUT= WORK.Outc06Q1 
            DATAFILE= "C:\Users\karmo\OneDrive\Desktop\SAS\dev\faers\data\raw\2006\OUTC06Q1.TXT" 
            DBMS=DLM REPLACE;
     DELIMITER='24'x; 
     GETNAMES=YES;
     DATAROW=2; 
